...
import { AddSlideProps, BackgroundProps, IChartMulti, IChartOptsLib, IOptsChartData, ImageProps, MediaProps, PresLayout, PresSlide, ShapeProps, SlideLayout, SlideMasterProps, TableProps, TableRow, TextProps, TextPropsOptions, Container } from './core-interfaces';
/**
 ...
 * }
 */
export declare function addChartDefinition(target: Container, slide: PresSlide, type: CHART_NAME | IChartMulti[], data: IOptsChartData[], opt: IChartOptsLib): object;
/**
 ...
 */
export declare function addImageDefinition(target: Container, slide: PresSlide, opt: ImageProps): void;
/**
 ...
 */
export declare function addMediaDefinition(target: Container, slide: PresSlide, opt: MediaProps): void;
/**
 ...
 */
export declare function addShapeDefinition(target: Container, slide: PresSlide, shapeName: SHAPE_NAME, opts: ShapeProps): void;
/**
 ...
 */
export declare function addTableDefinition(target: Container, slide: PresSlide, tableRows: TableRow[], options: TableProps, slideLayout: SlideLayout, presLayout: PresLayout, addSlide: (options?: AddSlideProps) => PresSlide, getSlide: (slideNumber: number) => PresSlide): void;
/**
 ...
 * @since: 1.0.0
 */
export declare function addTextDefinition(target: Container, slide: PresSlide, text: TextProps[], opts: TextPropsOptions, isPlaceholder: boolean): void;
/**
