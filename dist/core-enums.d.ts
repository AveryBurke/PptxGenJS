...
export declare const EMU = 914400;
export declare const ONEPT = 12700;
export declare const CRLF = "\r\n";
export declare const LAYOUT_IDX_SERIES_BASE = 2147483649;
...
export declare const DEF_CELL_MARGIN_IN: [number, number, number, number];
export declare const DEF_CHART_BORDER: BorderProps;
export declare const DEF_CHART_GRIDLINE: OptsChartGridLine;
export declare const DEF_FONT_COLOR = "000000";
export declare const DEF_FONT_SIZE = 12;
export declare const DEF_FONT_TITLE_SIZE = 18;
...
export declare const AXIS_ID_VALUE_PRIMARY = "2094734552";
export declare const AXIS_ID_VALUE_SECONDARY = "2094734553";
export declare const AXIS_ID_CATEGORY_PRIMARY = "2094734554";
export declare const AXIS_ID_CATEGORY_SECONDARY = "2094734555";
export declare const AXIS_ID_SERIES_PRIMARY = "2094734556";
...
export declare const BARCHART_COLORS: string[];
export declare const PIECHART_COLORS: string[];
...
export declare const SLDNUMFLDID = "{F7021451-1387-4CA6-816F-3879F97B5CBC}";
